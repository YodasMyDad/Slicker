 ...
 * Add slide
 */
export function slickAdd(markup, index, addBefore) {
    const _ = this;
 ...
 * Remove slide
 */
export function slickRemove(index, removeBefore, removeAll) {
    const _ = this;
    if (typeof index === 'boolean') {
        removeBefore = index;
 ...
 * Filter slides
 */
export function slickFilter(filter) {
    const _ = this;
    if (filter !== null) {
        _.$slidesCache = _.$slides;
        _.unload();
 ...
 * Set option
 */
export function slickSetOption(option, value, refresh = false) {
    const _ = this;
    let type = null;
 ...
 * Destroy slider
 */
export function destroy(refresh) {
    const _ = this;
    _.autoPlayClear();
    _.touchObject = {};
    _.cleanUpEvents();
 ...
 */
export function cleanUpSlideEvents() {
    const _ = this;
    if (_.$list) {
        EventManager.off(_.$list, 'mouseenter.slick');
        EventManager.off(_.$list, 'mouseleave.slick');
 ...
 */
export function initSlideEvents() {
    const _ = this;
 ...
 * Refresh slider
 */
export function refresh(initializing) {
    const _ = this;
