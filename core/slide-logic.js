 ...
 */
export function changeSlide(event, dontAnimate) {
    const _ = this;
 ...
 * Main slide handler
 */
export function slideHandler(index, sync = false, dontAnimate) {
    const _ = this;
 ...
 */
export function postSlide(index) {
    const _ = this;
    if (!_.unslicked) {
 ...
 */
export function getLeft(slideIndex) {
    const _ = this;
    let targetLeft;
    let verticalHeight;
 ...
 * AsNavFor sync
 */
export function asNavFor(index) {
    const _ = this;
