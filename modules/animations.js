 ...
 */
export function animateSlide(targetLeft, callback) {
    const _ = this;
    _.animateHeight();
 ...
 */
export function applyTransition(slide) {
    const _ = this;
    if (!_.transitionType)
        return;
    let transitionValue;
 ...
 */
export function disableTransition(slide) {
    const _ = this;
    if (!_.transitionType)
        return;
    if (_.options.fade === false) {
 ...
 * Fade in a slide
 */
export function fadeSlide(slideIndex, callback) {
    const _ = this;
    if (_.cssTransitions === false) {
 ...
 * Fade out a slide
 */
export function fadeSlideOut(slideIndex) {
    const _ = this;
    if (_.cssTransitions === false) {
 ...
 */
export function setCSS(position) {
    const _ = this;
    if (_.options.rtl === true) {
        position = -position;
    }
